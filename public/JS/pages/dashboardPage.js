/*Import functions */
    ...
    import { unjoinEvent } from "./clubServices.js";
    import { hasJoinedEvent } from "./clubServices.js";
    import { getMe } from "./clubServices.js";
...
async function initDashboard() {
    ...
    // Fetch role and club ownership from the server — not from sessionStorage which can be tampered with.
    const { role: currentRole, myClubId: serverMyClubId } = await getMe();
    const isOwnerSession = currentRole === "club_owner";
    ...
    /* Full eventlist*/
        ...
        const isOwner = currentRole === "club_owner";
